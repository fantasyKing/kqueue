...
//var consumerGroup2 = new ConsumerGroup(Object.assign({id: 'c1'}, consumerOptions), topics);
//consumerGroup2.on('error', onError);
//consumerGroup2.on('message', onMessage);

var consumerGroup = new ConsumerGroup(Object.assign({id: 'c1'}, consumerOptions), topics);
